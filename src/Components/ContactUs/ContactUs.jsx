...
const ContactUs = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!UserDetails.Cname || !UserDetails.Cemail || !UserDetails.Cphone || !UserDetails.selectedOption || !UserDetails.message) {
    ...
    if (!emailPattern.test(UserDetails.Cemail)) {
  ...
  return (
    ...
    <Toaster richColors position="top-right"/>
      ...
      <div
        className="contact__section sp_top_50 sp_bottom_50"
        data-aos="fade-up"
      >
        <div className="container">
          <div className="row">
            ...
            <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12 d-flex">
            ...
            <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12 d-flex">
              <div className="single__contact">
                ...
                <div className="contact__text">
                  ...
                  <div className="contact__email">
                    <p>sco-25 second floor civil lines gurgoan haryana</p>
                  </div>
                </div>
              </div>
            </div>
                  ...
                  <div className="row">
                    ...
                    <div className="col-xl-6" data-aos="fade-up">
                      <div className="contact__input__wraper">
                        <select
                          name="selectedOption"
                          value={UserDetails.selectedOption}
                          onChange={handleChange}
                          required
                        >
                          <option value="">-Choose any one-</option>
                          <option value="DeltaView Subscription">DeltaView Subscription</option>
                          <option value="School">School</option>
                          <option value="Coaching Institute/Tuition Centre">Coaching Institute/Tuition Centre</option>
                          <option value="Tablet/TV/IFP">Tablet/TV/IFP</option>
                    ...
                    <div className="col-xl-12" data-aos="fade-up">
                      <div className="contact__input__wraper">
                        <textarea
                          ...
                          value={UserDetails.message} // Set the value to the state value
                    ...
                    <div className="col-xl-12" data-aos="fade-up">
                      <div className="contact__button mt-3">
                        <button
