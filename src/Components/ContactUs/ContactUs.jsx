...
const ContactUs = () => {
  return (
    ...
    <div className="contact__section sp_top_50 sp_bottom_50" data-aos="fade-up">
          ...
          <div className="col-xl-12">
            <div className="contact__form__inner">
              ...
              <form
                ...
                action="https://html.themewin.com/edurock-preview/edurock/mail.php"
                method="post"
              >
                <div className="row">
                  ...
                  <div className="col-xl-6" data-aos="fade-up">
                    <div className="contact__input__wraper">
                      <select>
                        ...
                        <option value={0}>DeltaView Subscription</option>
                        <option value={1}>School</option>
                        <option value={2}>
                          Coaching Institute/Tuition Centre
                        </option>
                        <option value={3}>Tablet/TV/IFP</option>
