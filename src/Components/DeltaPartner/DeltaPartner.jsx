...
const DeltaPartner = () => {
  return (
    <>
          ...
          <div className="row">
              ...
              <div className="herobannerarea__content__wraper">
                <div className="herobannerarea__title">
                  <div className="herobannerarea__title__heading__2 herobannerarea__title__heading__3">
                    <h2>
                      Partner <span>with</span> DeltaView
                    </h2>
                  </div>
                </div>
            ...
            >
              <img
                loading="lazy"
                className="img-fluid"
                src="./src/assets/img/Partner-With-deltaview.png"
                alt="aboutimg"
              />
            </div>
          </div>
      ...
      <section className="our-value-sec partner-with pt-pb-100 bg-light">
        <div className="container">
          <div className="row">
            <div
            ...
            >
              <div className="section__title__heading heading__underline">
                <h2 className="mb-3 fw-normal">
                  DeltaView is a partner first platform and we envision scaling
                  it along with vision aligned growth partners
                </h2>
                <p>
                  We aspire to build strategic Sales &amp; Growth partnerships
                  with edtech companies, smart class hardware and tablet
                  manufacturers, resellers, distributors, education
                  entrepreneurs and organizations working to take best in class
                  yet affordable digital education to students and schools pan
                  country
                </p>
              </div>
            </div>
          ...
          <div className="row">
            <div
              className="section__title text-center aos-init aos-animate mb-3"
              data-aos="fade-up"
            >
              <div className="section__title__heading heading__underline">
                <h2 className="mb-0">Here’s why you should Partner with us</h2>
              </div>
            </div>
          </div>
          <div className="row border-r10">
            <div className="col-lg-6 col-md-6 col-sm-12 col-12 d-flex p-0">
      ...
      <section className="our-value-sec partner-with pt-pb-100 bg-dark bg-gradient">
        <div className="container">
          <div className="row">
            <div
              className="section__title text-center aos-init aos-animate"
            ...
            >
              <div className="section__title__heading heading__underline">
                <h2 className="mb-3 text-white">
                  Track your Business and Earnings
                </h2>
            ...
            <div className="col-lg-7">
              <div className="list-become">
                <ul>
                  ...
                  <li>Fill up the form below and send it to us</li>
                  <li>
                    Our team will get in touch with you &amp; guide you for next
                    steps
                  </li>
                  <li>
                    Once onboarded as partner, we will train you &amp; create a
                    unique partner code
                  </li>
                  <li>
                    Partner code will give discount to your users &amp; track
                    your earnings
                  </li>
                  <li>
                    You can also buy prepaid codes from us &amp; then sell those
                    to students
                  </li>
                </ul>
              </div>
                  ...
                  <div className="dashboard__single__counter">
                    <div className="counterarea__text__wraper d-block text-center">
                      <div className="counter__img mb-2 me-0">
                        <img
                          loading="lazy"
                          src="./src/assets/img/counter/maths.png"
                          alt="counter"
                        />
                      </div>
                  ...
                  <div className="dashboard__single__counter">
                    <div className="counterarea__text__wraper d-block text-center">
                      <div className="counter__img mb-2 me-0">
                        <img
                          loading="lazy"
                          src="./src/assets/img/counter/physics.png"
                          alt="counter"
                        />
                      </div>
                      <div className="counter__content__wraper">
                  ...
                  <div className="dashboard__single__counter">
                    <div className="counterarea__text__wraper d-block text-center">
                      <div className="counter__img mb-2 me-0">
                        <img
                          loading="lazy"
                          src="./src/assets/img/counter/chemistry.png"
                          alt="counter"
                        />
                      </div>
                      <div className="counter__content__wraper">
                  ...
                  <div className="dashboard__single__counter">
                    <div className="counterarea__text__wraper d-block text-center">
                      <div className="counter__img mb-2 me-0">
                        <img
                          loading="lazy"
                          src="./src/assets/img/counter/biology.png"
                          alt="counter"
                        />
                      </div>
                      <div className="counter__content__wraper">
                  ...
                  <div className="dashboard__single__counter">
                    <div className="counterarea__text__wraper d-block text-center">
                      <div className="counter__img mb-2 me-0">
                        <img
                          loading="lazy"
                          src="./src/assets/img/counter/eng.png"
                          alt="counter"
                        />
                      </div>
                      <div className="counter__content__wraper">
                  ...
                  <div className="dashboard__single__counter">
                    <div className="counterarea__text__wraper d-block text-center">
                      <div className="counter__img mb-2 me-0">
                        <img
                          loading="lazy"
                          src="./src/assets/img/counter/hindi.png"
                          alt="counter"
                        />
                      </div>
                      <div className="counter__content__wraper">
                  ...
                  <div className="dashboard__single__counter">
                    <div className="counterarea__text__wraper d-block text-center">
                      <div className="counter__img mb-2 me-0">
                        <img
                          loading="lazy"
                          src="./src/assets/img/counter/sanskrit.png"
                          alt="counter"
                        />
                      </div>
                      <div className="counter__content__wraper">
                  ...
                  <div className="dashboard__single__counter">
                    <div className="counterarea__text__wraper d-block text-center">
                      <div className="counter__img mb-2 me-0">
                        <img
                          loading="lazy"
                          src="./src/assets/img/counter/computer.png"
                          alt="counter"
                        />
                      </div>
                      <div className="counter__content__wraper">
              ...
              <div className="about__right__wraper__2 about__right__wraper__4">
                <div className="educationarea__img text-end d-flex">
                  <img
                    ...
                    src="./src/assets/img/Select-Your-Grade-When-Joining.png"
                    alt="about"
                  />
                  <img
                    loading="lazy"
              ...
              <div className="about__right__wraper__2 about__right__wraper__4">
                <div className="text-end">
                  <img
                    loading="lazy"
                    className="img-fluid"
                    src="./src/assets/img/Enjoyable-Learning-Content-On.png"
                    alt="about"
                  />
                </div>
              </div>
              ...
              <div className="about__right__wraper__2 about__right__wraper__4">
                <div className="educationarea__img text-end d-flex">
                  <img
                    loading="lazy"
                    className="aboutimg__4__img__1"
                    src="./src/assets/img/STEM-Projects-On.png"
                    alt="about"
                  />
                  <img
                    loading="lazy"
                    className="aboutimg__4__img__1"
                    src="./src/assets/img/Interesting-Practical_Project-Videos-On.png"
                    alt="about"
                  />
                </div>
              </div>
              ...
              <div className="about__right__wraper__2 about__right__wraper__4">
                <div className="educationarea__img text-end d-flex">
                  <img
                    loading="lazy"
                    className="aboutimg__4__img__1"
                    src="./src/assets/img/Chapter-Wise-Tests-With-Timer-On.png"
                    alt="about"
                  />
                  <img
                    loading="lazy"
                    className="aboutimg__4__img__1"
                    src="./src/assets/img/Quickly-Check-Your-Test-Journey-with.png"
                    alt="about"
                  />
                </div>
              </div>
