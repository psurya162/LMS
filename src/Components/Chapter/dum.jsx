...
const ChapterPage2 = ({ selectedSubjectId ,userData,setUserData }) => {
    ...
    const fetchVideos = async () => {
      try {
        ...
        if (response.data.videos.length > 0) {
          const { videos, playLimit } = response.data;
                          ...
                          <div className="accordion-body course-layout-content-box-inner ps-0 pe-0">
                            <ul className="nav nav-tabs d-block" role="tablist">
                              {videos
                                ...
                                .map((videoItem, i) => {
                                  // Check if the current video index is within the play limit
                                  if (
                                    i < playLimit ||
                                    ...
                                    return (
                                      ...
                                      >
                                        <button
                                          ...
                                          onClick={() =>
                                            handleVideoClick(videoItem.url)
                                          }
                                        >
                                          <i
                                            className={`${
